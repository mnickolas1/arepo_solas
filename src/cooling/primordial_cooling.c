 ...
 *  \return void
 */
static void find_abundances_and_rates(double logT, double rho, double *ne_guess)
{
  double neold, nenew;
  int j, niter;
  double flow, fhi, t;
 ...
 */
static double CoolingRate(double logT, double rho, double *nelec)
{
  double Lambda, Heat;
 ...
 *  \return void
 */
static void MakeRateTable(void)
{
  int i;
  double T;
  double Tfact;
 ...
 *  \return void
 */
static void ReadIonizeParams(char *fname, int which)
{
  int iter, i;
  FILE *fdcool;
  float dummy;
